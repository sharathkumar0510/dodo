    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          >
            <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-gradient-to-r from-purple-500 to-blue-600 flex items-center justify-center">
              <span className="text-4xl font-bold text-white">DA</span>
            </div>
            <h1 className="text-2xl font-bold text-gray-900">Dodo Admin</h1>
            <p className="text-gray-600 mt-2">Platform Management</p>
          </motion.div>
        </motion.div>
      )}
    </AnimatePresence>
